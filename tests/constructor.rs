...
mod bigint {
    ...
    #[test]
    fn should_create_bigint_from_a_string_with_zero_and_leading_zeros() {
        // When
        let bigint_value = bigint::BigInt::from_string("0000".to_string(), bigint::Base::Decimal);
    ...
    #[test]
    fn should_create_bigint_from_a_string_with_a_signed_zero() {
        // When
        let bigint_value = bigint::BigInt::from_string("-0".to_string(), bigint::Base::Decimal);
    ...
    #[test]
    fn should_create_bigint_from_a_string_with_a_single_digit_and_leading_zeros() {
        // When
        let bigint_value = bigint::BigInt::from_string("0001".to_string(), bigint::Base::Decimal);
    ...
    #[test]
    fn should_create_bigint_from_a_string_with_a_negative_single_digit() {
        // When
        let bigint_value = bigint::BigInt::from_string("-1".to_string(), bigint::Base::Decimal);
